...
export default function AssessPage() {
  ...
  async function onSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      const savings = calcSavingsProgress([]); // simple v1: no goals yet
  ...
  return (
    <main className="max-w-xl mx-auto p-6 space-y-6">
      ...
      <p className="text-sm text-gray-600">This quick snapshot stays in your browser. No login required.</p>
