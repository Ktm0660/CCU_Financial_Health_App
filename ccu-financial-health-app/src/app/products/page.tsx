...
export default function Products(){
  return (
    <div className="section-gap">
      ...
      <div className="grid-cards md:grid-cols-2">
        {products.map((p)=>(
          <section key={p.name} className="card p-6 sm:p-8 space-y-3">
            ...
            <button className="btn btn-primary" aria-label={`I'm interested in ${p.name}`}>
              I’m interested
            </button>
          </section>
        ))}
